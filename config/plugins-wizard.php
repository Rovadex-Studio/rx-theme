	...
	'advanced' => array(
		'default' => array(
			...
			'additional_info' => array(
				...
				'description' => esc_html__( 'An ideal solution particularly regards to plumber and water service as well as it enables you to build a wide variety of business websites.', 'rvdx-theme' ),
				'social_links' => array(
					'facebook' => array(
						'icon' => '#',
						'link' => '#',
