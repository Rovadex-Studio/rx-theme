	...
	return apply_filters( 'rvdx-theme/customizer/options' , array(
		...
		'options'       => array(
			...
			'blog_post_image_size' => array(
				'title'    => esc_html__( 'Post Image Size', 'rvdx-theme' ),
				'section'  => 'blog',
				'default'  => 'original',
				'field'    => 'select',
				'priority' => 52,
				'choices' => array(
					'original'      => esc_html__( 'Original Size', 'rvdx-theme' ),
					'full-width'      => esc_html__( 'Full Width', 'rvdx-theme' ),
					'fill-container' => esc_html__( 'Fill Container', 'rvdx-theme' ),
				),
				'type'    => 'control',
			),
