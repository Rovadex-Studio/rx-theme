...
if ( ! function_exists( 'rvdx_theme_wc_cart_link' ) ) {
	...
	function rvdx_theme_wc_cart_link() {
		?>
			<a class="header-cart__link" href="#" title="<?php esc_attr_e( 'View your shopping cart', 'rvdx-theme' ); ?>">
		  <?php
		  $item_count_text = sprintf(
		  /* translators: number of items in the mini cart. */
			  esc_html__( '%d', 'rvdx-theme' ),
...
if ( ! function_exists( 'rvdx_theme_wc_header_cart' ) ) {
	...
	function rvdx_theme_wc_header_cart() {
		...
		?>
			...
			<?php
			$instance = array( 'title' => esc_html__( 'My cart', 'rvdx-theme' ) );
